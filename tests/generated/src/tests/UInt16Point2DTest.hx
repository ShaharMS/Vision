...
class UInt16Point2DTest extends utest.Test {
    ...
    function test_x() {
        var result = vision.ds.UInt16Point2D.x;
        Assert.notNull(result);
    }

    function test_y() {
        var result = vision.ds.UInt16Point2D.y;
        Assert.notNull(result);
    }

    function test_toString() {
        var this = 0;
        var result = vision.ds.UInt16Point2D.toString(this);
        Assert.notNull(result);
    }

    function test_toPoint2D() {
        var this = 0;
        var result = vision.ds.UInt16Point2D.toPoint2D(this);
        Assert.notNull(result);
    }

    function test_toIntPoint2D() {
        var this = 0;
        var result = vision.ds.UInt16Point2D.toIntPoint2D(this);
        Assert.notNull(result);
    }

    function test_toInt() {
        var this = 0;
        var result = vision.ds.UInt16Point2D.toInt(this);
        Assert.notNull(result);
    }
