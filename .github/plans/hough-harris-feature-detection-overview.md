...
| 5 | [hough-harris-feature-detection-5-hough-circles.md](.github/plans/hough-harris-feature-detection-5-hough-circles.md) | ▶ Next — Add a separate gradient-based Hough circle detector with radius and center controls. |
